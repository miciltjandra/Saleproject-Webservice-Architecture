...
//                            out.println(id);
        ...
        <%-- end web service invocation --%>
            ...
            <span style="margin-right:14px">Product</span>: <% out.println(request.getParameter("product"));%> <br>
            <span style="margin-right:14px">Quantity</span>:
            <input type="number" id="quantity" name="quantity" autocomplete="off" value="1" required min="1" maxlength="10" max="9999999999"/> PCS<br>
            ...
            <br /><br />
            Full Address <br />
            <textarea class="reg_text" rows="4" form="addform" name="address" required="required" ></textarea> 
            <br /><br />
            Postal Code <br />
